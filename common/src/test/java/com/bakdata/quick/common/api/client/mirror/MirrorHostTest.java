...
class MirrorHostTest {
    ...
    void shouldConstructCorrectUrlForKeyRequest() {
        final MirrorHost mirrorHost = MirrorHost.createMirrorHostForService("test-for-key");
    ...
    void shouldConstructCorrectUrlForKeysRequest() {
        final MirrorHost mirrorHost = MirrorHost.createMirrorHostForService("test-for-keys");
    ...
    void shouldConstructCorrectUrlForAllRequest() {
        final MirrorHost mirrorHost = MirrorHost.createMirrorHostForService("test-for-all");
    ...
    void shouldConstructCorrectUrlForRangeRequest() {
        final MirrorHost mirrorHost = MirrorHost.createMirrorHostForService("test-for-rage");
    ...
    void shouldBeEqualIfTheTopicNameIsTheSame() {
        final MirrorHost firstMirrorHost = MirrorHost.createMirrorHostForService("topic-1");
        final MirrorHost secondMirrorHost = MirrorHost.createMirrorHostForService("topic-1");
        assertThat(firstMirrorHost).isEqualTo(secondMirrorHost);
    }

    @Test
    void shouldReturnHostWhenConvertedToString() {
        final MirrorHost mirrorHost = MirrorHost.createMirrorHostForService("test-for-to-string");
    ...
    void shouldConstructCorrectUrlWithIpAndPort() {
        final MirrorHost mirrorHost = MirrorHost.createMirrorHostForDirectIpAccess("10.30.40.0:8080");
        final HttpUrl actual = mirrorHost.forKey("give-me-key");
