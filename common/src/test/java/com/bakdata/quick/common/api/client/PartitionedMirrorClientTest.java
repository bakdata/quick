...
//        final TopicTypeService typeService = createTopicTypeService(keyInfo.getType(), QuickTopicType.STRING, null);
//        this.stringMirrorClient =
//            new PartitionedMirrorClient<>(this.mirrorHost, this.client, typeService, this.partitionFinder);
//    }
//
//    @Test
...
//        final KafkaConfig kafkaConfig = new KafkaConfig("dummy:123", "mock");
