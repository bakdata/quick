 ...
 */
public class ApplicationService implements QuickResource {

    private final QuickResourceErrorHandler errorHandler;
    private final Service service;

    public ApplicationService(final Service service) {
        this.service = service;
        this.errorHandler = new KubernetesErrorHandler(this.service.getMetadata().getName(), this.service.getKind());
    }
